...
akeeba.loadScripts.push(function() {
		...
		akeeba.Fsfilters.translations['COM_AKEEBA_FILEFILTERS_TYPE_DIRECTORIES'] = '{$strings['COM_AKEEBA_FILEFILTERS_TYPE_DIRECTORIES']}';
		akeeba.Fsfilters.translations['COM_AKEEBA_FILEFILTERS_TYPE_SKIPFILES'] = '{$strings['COM_AKEEBA_FILEFILTERS_TYPE_SKIPFILES']}';
		akeeba.Fsfilters.translations['COM_AKEEBA_FILEFILTERS_TYPE_SKIPDIRS'] = '{$strings['COM_AKEEBA_FILEFILTERS_TYPE_SKIPDIRS']}';
		akeeba.Fsfilters.translations['COM_AKEEBA_FILEFILTERS_TYPE_FILES'] = '{$strings['COM_AKEEBA_FILEFILTERS_TYPE_FILES']}';
		akeeba.Fsfilters.translations['COM_AKEEBA_FILEFILTERS_TYPE_DIRECTORIES_ALL'] = '{$strings['COM_AKEEBA_FILEFILTERS_TYPE_DIRECTORIES_ALL']}';
		akeeba.Fsfilters.translations['COM_AKEEBA_FILEFILTERS_TYPE_SKIPFILES_ALL'] = '{$strings['COM_AKEEBA_FILEFILTERS_TYPE_SKIPFILES_ALL']}';
		akeeba.Fsfilters.translations['COM_AKEEBA_FILEFILTERS_TYPE_SKIPDIRS_ALL'] = '{$strings['COM_AKEEBA_FILEFILTERS_TYPE_SKIPDIRS_ALL']}';
		akeeba.Fsfilters.translations['COM_AKEEBA_FILEFILTERS_TYPE_FILES_ALL'] = '{$strings['COM_AKEEBA_FILEFILTERS_TYPE_FILES_ALL']}';
		akeeba.Fsfilters.translations['COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLDIRS'] = '{$strings['COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLDIRS']}';
		akeeba.Fsfilters.translations['COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLFILES'] = '{$strings['COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLFILES']}';
