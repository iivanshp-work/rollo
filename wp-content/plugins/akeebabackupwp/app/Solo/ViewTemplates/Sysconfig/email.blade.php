...
<div class="akeeba-form-group">
	...
	<div class="akeeba-toggle">
		{{ FEFSelect::booleanList('mail_online', ['forToggle' => 1], $config->get('mail.online', 1)) }}
	</div>
...
<div class="akeeba-form-group">
	...
	{{ \Solo\Helper\Setup::mailerSelect($config->get('mail.mailer'), 'mail_mailer') }}
	<p class="akeeba-help-text">
...
<div class="akeeba-form-group">
	...
	<div class="akeeba-toggle">
		{{ FEFSelect::booleanList('mail_smtpauth', array('forToggle' => 1), $config->get('mail.smtpauth', 1)) }}
	</div>
	<p class="akeeba-help-text">
...
<div class="akeeba-form-group">
	...
	{{ \Solo\Helper\Setup::smtpSecureSelect($config->get('mail.smtpsecure'), 'mail_smtpsecure') }}
	<p class="akeeba-help-text">
