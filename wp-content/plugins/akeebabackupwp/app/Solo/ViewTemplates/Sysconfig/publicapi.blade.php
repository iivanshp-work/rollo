...
<div class="akeeba-form-group">
    ...
    <div class="akeeba-toggle">
		{{ FEFSelect::booleanList('options[legacyapi_enabled]', ['id' => 'legacyapi_enabled', 'forToggle' => 1], $config->get('options.legacyapi_enabled', 0)) }}
    </div>
...
<div class="akeeba-form-group">
    ...
    <div class="akeeba-toggle">
		{{ FEFSelect::booleanList('options[jsonapi_enabled]', ['id' => 'jsonapi_enabled', 'forToggle' => 1], $config->get('options.jsonapi_enabled', 0)) }}
    </div>
    <p class="akeeba-help-text">
...
<div class="akeeba-form-group">
    ...
    <div class="akeeba-toggle">
		{{ FEFSelect::booleanList('options[frontend_email_on_finish]', ['id' => 'frontend_email_on_finish', 'forToggle' => 1], $config->get('options.frontend_email_on_finish', 0)) }}
    </div>
    <p class="akeeba-help-text">
