...
<div class="akeeba-form-group">
    ...
    <div class="akeeba-toggle">
	    {{ FEFSelect::booleanList('useencryption', array('forToggle' => 1), $config->get('useencryption', 1)) }}
    </div>
    <p class="akeeba-help-text">
...
<div class="akeeba-form-group">
    ...
    <div class="akeeba-toggle">
	    {{ FEFSelect::booleanList('localtime', array('forToggle' => 1), $config->get('localtime', 1)) }}
    </div>
    <p class="akeeba-help-text">
...
<div class="akeeba-form-group">
    ...
    <div class="akeeba-toggle">
		{{ FEFSelect::booleanList('showDeleteOnRestore', array('forToggle' => 1), $config->get('showDeleteOnRestore', 0)) }}
    </div>
    <p class="akeeba-help-text">
...
<div class="akeeba-form-group">
    ...
    <div class="akeeba-toggle">
	    {{ FEFSelect::booleanList('stats_enabled', array('forToggle' => 1), $config->get('stats_enabled', 1)) }}
    </div>
    <p class="akeeba-help-text">
