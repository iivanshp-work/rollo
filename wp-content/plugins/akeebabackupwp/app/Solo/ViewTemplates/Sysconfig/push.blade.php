...
<div class="akeeba-form-group">
    ...
    <div class="akeeba-toggle">
		{{ FEFSelect::booleanList('options[desktop_notifications]', ['id' => 'desktop_notifications', 'forToggle' => 1], $config->get('options.desktop_notifications', 0)) }}
    </div>
...
<div class="akeeba-form-group">
    ...
    <div class="akeeba-toggle">
		{{ FEFSelect::booleanList('options[push_preference]', ['id' => 'push_preference', 'forToggle' => 1], $config->get('options.push_preference', 0)) }}
    </div>
    <p class="akeeba-help-text">
