...
<form action="@route('index.php?view=wizard&task=applySiteSettings')" method="post"
	...
	<div class="akeeba-panel--info">
        ...
        <div class="akeeba-form-group">
	        ...
	        {{ \Solo\Helper\Setup::scriptTypesSelect($config->get('akeeba.platform.scripttype', 'generic'), 'var[akeeba.platform.scripttype]') }}
            <p class="akeeba-help-text">
        ...
        <div class="akeeba-form-group">
	        ...
	        {{ \Solo\Helper\Setup::restorationScriptSelect($config->get('akeeba.advanced.embedded_installer', 'generic'), 'var[akeeba.advanced.embedded_installer]') }}
            <p class="akeeba-help-text">
