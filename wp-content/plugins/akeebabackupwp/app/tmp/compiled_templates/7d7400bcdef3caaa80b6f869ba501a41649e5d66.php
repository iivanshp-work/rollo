<?php /* /home/rollo/rollo.net.ua/www/wp-content/plugins/akeebabackupwp/app/Solo/ViewTemplates/Manage/default.blade.php */ ?>
<?php
/**
 * @package   solo
    ...
    <table class="akeeba-table--striped" id="itemsList">
        ...
        <tr>
            ...
            <td class="akeeba-hidden-phone">
                <?php echo \Awf\Html\Html::_('select.genericlist', $this->profilesList, 'profile',
                'onchange="document.forms.adminForm.submit()"', 'value', 'text', $this->lists->fltProfile); ?>
            </td>
            <td></td>
            <td></td>
                ...
                <tr>
                    ...
                    <td>
                        <span class="akeeba-label--grey akeebaCommentPopover" rel="popover"
                              data-original-title="<?php echo \Awf\Text\Text::_('COM_AKEEBA_BUADMIN_LABEL_ORIGIN'); ?>"
                              data-content="<?php echo $this->escape($originDescription); ?>"
