<?php /* /home/rollo/rollo.lviv.ua/dev/wp-content/plugins/akeebabackupwp/app/Solo/ViewTemplates/Wizard/wizard.blade.php */ ?>
<?php
/**
 * @package   solo
...
<div id="akeeba-confwiz">
	...
	<div id="backup-complete" style="display: none">
		<div class="akeeba-block--success">
            ...
            <button class="akeeba-btn--primary--big" onclick="window.location='<?php echo $this->container->router->route('index.php?&view=backup'); ?>'; return false;">
				<span class="akion-play"></span>
				<?php echo \Awf\Text\Text::_('COM_AKEEBA_BACKUP'); ?>
			</button>

            <button class="akeeba-btn--ghost" onclick="window.location='<?php echo $this->container->router->route('index.php?&view=configuration'); ?>'; return false;">
				<span class="akion-wrench"></span>
				<?php echo \Awf\Text\Text::_('COM_AKEEBA_CONFIG'); ?>
			</button>

			<?php if(AKEEBABACKUP_PRO): ?>
            <button class="akeeba-btn--ghost" onclick="window.location='<?php echo $this->container->router->route('index.php?&view=schedule'); ?>'; return false;">
