<?php /* /home/rollo/rollo.net.ua/www/wp-content/plugins/akeebabackupwp/app/Solo/ViewTemplates/Manage/manage_column.blade.php */ ?>
<?php
/**
 * @package   solo
...
<div style="display: none">
    <div id="akeeba-buadmin-<?php echo (int)$record['id']; ?>" tabindex="-1" role="dialog">
        <div class="akeeba-renderer-fef <?php echo ($this->getContainer()->appConfig->get('darkmode', -1) == 1) ? 'akeeba-renderer-fef--dark' : ''; ?>">
            ...
            <p>
                <strong><?php echo \Awf\Text\Text::_('COM_AKEEBA_BUADMIN_LBL_ARCHIVEPATH' . ($archiveExists ? '' : '_PAST')); ?></strong><br/>
            ...
            <p>
                <strong><?php echo \Awf\Text\Text::_('COM_AKEEBA_BUADMIN_LBL_ARCHIVENAME' . ($archiveExists ? '' : '_PAST')); ?></strong><br/>
                <br/>
                <code>
        ...
        <div class="akeeba-renderer-fef <?php echo ($this->getContainer()->appConfig->get('darkmode', -1) == 1) ? 'akeeba-renderer-fef--dark' : ''; ?>">
            ...
            <?php if($record['multipart'] < 2): ?>
                <a class="akeeba-btn--primary--small"
                   href="javascript:confirmDownload('<?php echo $thisID; ?>', '');">
            ...
            <?php if($record['multipart'] >= 2): ?>
                ...
                <?php for($count = 0; $count < $record['multipart']; $count++): ?>
                    ...
                    <a class="akeeba-btn--small--dark"
                       href="javascript:confirmDownload('<?php echo $thisID; ?>', '<?php echo urlencode($count); ?>');">
