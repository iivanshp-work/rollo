<?php /* /home/rollo/rollo.lviv.ua/dev/wp-content/plugins/akeebabackupwp/app/Solo/ViewTemplates/Backup/default.blade.php */ ?>
<?php
/**
 * @package   solo
...
<?php echo $this->loadAnyTemplate('Backup/script'); ?>
...
<div id="backup-setup" class="akeeba-panel--primary">
    ...
    <form action="<?php echo $router->route('index.php?view=backup')?>" method="post" name="profileForm"
		...
		<div class="akeeba-form-group">
			...
			<?php echo \Awf\Html\Html::_('select.genericlist', $this->profileList, 'profile', 'onchange="akeeba.Backup.flipProfile();" class="advancedSelect"', 'value', 'text', $this->profileId); ?>
		</div>
        ...
        <div id="errorframe">
            ...
            <div class="akeeba-block--info" id="error-panel-troubleshooting">
				<p>
					...
					<?php echo \Awf\Text\Text::sprintf('COM_AKEEBA_BACKUP_TEXT_RTFMTOSOLVE', 'https://www.akeebabackup.com/documentation/troubleshooter/abbackup.html?utm_source=akeeba_backup&utm_campaign=backuperrorlink'); ?>
				</p>
				<p>
					<?php if(AKEEBABACKUP_PRO): ?>
