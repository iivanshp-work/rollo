...
"undefined"===typeof akeeba.Fsfilters&&(akeeba.Fsfilters={translations:{},currentRoot:null,loadingGif:""});akeeba.Fsfilters.activeRootChanged=function(){var a=document.getElementById("active_root"),b={};b.root=a.options[a.selectedIndex].value;b.crumbs=[];b.node="";akeeba.Fsfilters.load(b)};akeeba.Fsfilters.load=function(a){a.verb="list";a=JSON.stringify(a);var b={};b.akaction=a;akeeba.System.doAjax(b,function(a){akeeba.Fsfilters.render(a)},null,!1,15E3)};
...
(akeeba.System.removeClass(e,"akion-android-star-outline"),akeeba.System.addClass(e,"akion-android-star")):-1!=e.className.indexOf("akion-android-star")&&(akeeba.System.addClass(e,"akion-android-star-outline"),akeeba.System.removeClass(e,"akion-android-star"))},250);akeeba.System.data.set(b,"akeebatimer",g)}var c={akaction:JSON.stringify(a)};akeeba.System.doAjax(c,function(c){if(null!=b){var g=akeeba.System.data.get(b,"akeebatimer");clearInterval(g);if(g=akeeba.System.data.get(b,"iconClass"))e.className=
g;akeeba.System.data.set(b,"iconClass",null);akeeba.System.data.set(b,"loading",null)}1==c.success?(null!=b&&f&&(1==c.newstate?(akeeba.System.removeClass(b,"akeeba-btn--grey"),akeeba.System.addClass(b,"akeeba-btn--orange")):(akeeba.System.removeClass(b,"akeeba-btn--orange"),akeeba.System.addClass(b,"akeeba-btn--grey"))),null!=d&&d(c,b)):(null!=d&&d(c,b),akeeba.System.modalErrorHandler(akeeba.Fsfilters.translations.COM_AKEEBA_FILEFILTERS_LABEL_UIERRORFILTER.replace("%s",a.node)))},function(a){if(null!=
b){var c=akeeba.System.data.get(b,"akeebatimer");clearInterval(c);e.className=akeeba.System.data.get(b,"iconClass");akeeba.System.data.set(b,"iconClass");akeeba.System.data.set(b,"loading")}akeeba.System.params.errorCallback(a)},!0,15E3)};
...
c.setAttribute("title",'<div class="tooltip-arrow-up-leftaligned"></div><div>'+akeeba.Fsfilters.translations["COM_AKEEBA_FILEFILTERS_TYPE_"+g.toUpperCase()]+"</div>");c.setAttribute("data-akeeba-tooltip-position","right");var k="";switch(g){case "directories_all":k="akion-close-circled";c.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-close-circled"></span>');break;case "skipdirs_all":k="akion-folder";c.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-folder"></span>');
...
b.children[e].querySelector("span."+c),f=-1!=g.parentNode.className.indexOf("akeeba-btn--orange");!d&&!f||d&&f||akeeba.System.triggerEvent(g,"click")}}}(c,k));f.appendChild(c);akeeba.Tooltip.simpleTooltip(c)}c=document.createElement("span");c.className="folder-name";c.innerHTML='<span class="pull-left akion-arrow-down-a"></span>'+akeeba.Fsfilters.translations.COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLDIRS;f.appendChild(c);b.appendChild(f)}for(var h in a.folders){if(!a.folders.hasOwnProperty(h))return;
f=a.folders[h];uielement=document.createElement("div");uielement.className="folder-container";d=["directories","skipdirs","skipfiles"];for(e=0;e<d.length;e++){g=d[e];c=document.createElement("span");c.className="akeeba-btn--mini akeeba-btn--grey folder-icon-container";c.setAttribute("title",'<div class="tooltip-arrow-up-leftaligned"></div><div>'+akeeba.Fsfilters.translations["COM_AKEEBA_FILEFILTERS_TYPE_"+g.toUpperCase()]+"</div>");switch(g){case "directories":c.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-close-circled"></span>');
...
"akeeba-btn--orange");case 0:akeeba.System.addEventListener(c,"click",function(c,b,d){return function(){akeeba.Fsfilters.toggle({root:a.root,crumbs:crumbs,node:c,filter:b,verb:"toggle"},d)}}(h,g,c))}uielement.appendChild(c)}c=document.createElement("span");c.textContent=h;c.className="folder-name";akeeba.System.addEventListener(c,"click",function(c){return function(){var b=document.createElement("img");b.setAttribute("src",akeeba.Fsfilters.loadingGif);b.setAttribute("width",16);b.setAttribute("height",
...
c.insertAdjacentHTML("beforeend",'<span class="ak-toggle-button akion-close-circled"></span>'),c.setAttribute("title",'<div class="tooltip-arrow-up-leftaligned"></div><div>'+akeeba.Fsfilters.translations.COM_AKEEBA_FILEFILTERS_TYPE_FILES_ALL+"</div>"),c.setAttribute("data-akeeba-tooltip-position","right"),akeeba.Tooltip.simpleTooltip(c),akeeba.System.addEventListener(c,"click",function(a){return function(){if(-1!=this.className.indexOf("akeeba-btn--orange")){akeeba.System.removeClass(this,"akeeba-btn--orange");
...
'<span class="pull-left akion-arrow-down-a"></span>'+akeeba.Fsfilters.translations.COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLFILES,g.appendChild(c),h.appendChild(g));for(fileName in a.files)if(a.files.hasOwnProperty(fileName)){f=a.files[fileName];uielement=document.createElement("div");uielement.className="file-container";d=["files"];for(e=0;e<d.length;e++){g=d[e];c=document.createElement("span");c.className="file-icon-container akeeba-btn--mini akeeba-btn--grey";switch(g){case "files":c.insertAdjacentHTML("beforeend",
'<span class="ak-toggle-button akion-close-circled"></span>')}c.setAttribute("title",'<div class="tooltip-arrow-up-leftaligned"></div><div>'+akeeba.Fsfilters.translations["COM_AKEEBA_FILEFILTERS_TYPE_"+g.toUpperCase()]+"</div>");c.setAttribute("data-akeeba-tooltip-position","right");akeeba.Tooltip.simpleTooltip(c);switch(f[g]){case 2:akeeba.System.removeClass(c,"akeeba-btn--grey");akeeba.System.addClass(c,"akeeba-btn--red");break;case 1:akeeba.System.removeClass(c,"akeeba-btn--grey"),akeeba.System.addClass(c,
...
akeeba.Fsfilters.nuke=function(){var a={akaction:JSON.stringify({root:akeeba.Fsfilters.currentRoot,verb:"reset"})};akeeba.System.doAjax(a,function(a){akeeba.Fsfilters.render(a)},null,!1,15E3)};akeeba.Fsfilters.loadTab=function(a){a={akaction:JSON.stringify({verb:"tab",root:a})};akeeba.System.doAjax(a,function(a){akeeba.Fsfilters.renderTab(a)},null,!1,15E3)};
akeeba.Fsfilters.addRow=function(a,b){var d=akeeba.Fsfilters.translations["COM_AKEEBA_FILEFILTERS_TYPE_"+a.type.toUpperCase()];null==d&&(d=a.type);var f=document.createElement("tr");f.className="ak_filter_row";var e=document.createElement("td");f.appendChild(e);e.className="ak_filter_type";e.insertAdjacentHTML("beforeend",d);d=document.createElement("td");f.appendChild(d);d.className="ak_filter_item";e=document.createElement("span");d.appendChild(e);e.className="ak_filter_tab_icon_container akeeba-btn--mini akeeba-btn--red deletecontainer";
...
akeeba.Fsfilters.renderCrumbs=function(a){var b=[],d=[akeeba.Fsfilters.translations.COM_AKEEBA_FILEFILTERS_UIROOT,a.root,[],""];b.push(d);var f=0;if(0<a.crumbs.length){var e=[];for(f=0;f<a.crumbs.length;f++){var g=a.crumbs[f];d=[g,a.root,e.slice(0),g];b.push(d);e.push(g)}}a=document.getElementById("ak_crumbs");a.innerHTML="";g=null;for(f=0;f<b.length;f++){g=b[f];d=document.createElement("li");var c=document.createElement("a");c.setAttribute("href","javascript:");g[0]=g[0].replace("&lt;","<").replace("&gt;",
">");c.textContent=g[0];akeeba.System.addEventListener(c,"click",function(a){return function(){var b=document.createElement("img");b.setAttribute("src",akeeba.Fsfilters.loadingGif);b.setAttribute("width",16);b.setAttribute("height",11);b.setAttribute("border",0);b.setAttribute("alt","Loading...");b.style.marginTop="5px";b.style.marginLeft="5px";this.appendChild(b);akeeba.Fsfilters.load({root:a[1],crumbs:a[2],node:a[3]})}}(g));d.appendChild(c);g=document.createElement("span");g.textContent="/";d.appendChild(g);
a.appendChild(d)}return e};
akeeba.Fsfilters.renderParentFolderElement=function(){var a=document.getElementById("folders"),b=document.createElement("div");akeeba.System.addClass(b,"folder-container");b.insertAdjacentHTML("beforeend",'<span class="folder-padding"></span>');b.insertAdjacentHTML("beforeend",'<span class="folder-padding"></span>');b.insertAdjacentHTML("beforeend",'<span class="folder-padding"></span>');b.insertAdjacentHTML("beforeend",'<span class="akion-arrow-up-a"></span>');var d=document.createElement("span");d.className=
"folder-name folder-up";var f=document.getElementById("ak_crumbs").children;d.textContent="("+f[f.length-2].querySelector("a").textContent+")";akeeba.System.addEventListener(d,"click",function(){var a=document.getElementById("ak_crumbs").children;akeeba.System.triggerEvent(a[a.length-2].querySelector("a"),"click")});b.appendChild(d);a.appendChild(b)}; //# sourceMappingURL=fsfilters.min.map
