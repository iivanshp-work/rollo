...
"undefined"===typeof akeeba.Configuration&&(akeeba.Configuration={},akeeba.Configuration.translations={},akeeba.Configuration.GUI={},akeeba.Configuration.engines={},akeeba.Configuration.installers={},akeeba.Configuration.URLs={},akeeba.Configuration.FtpBrowser={params:{}},akeeba.Configuration.SftpBrowser={params:{}},akeeba.Configuration.FtpTest={},akeeba.Configuration.SftpTest={},akeeba.Configuration.FtpModal=null,akeeba.Configuration.passwordFields={},akeeba.Configuration.fsBrowser={params:{dialogId:"folderBrowserDialog",
dialogBodyId:"folderBrowserDialogBody"},modalObject:null});akeeba.Configuration.parseConfigData=function(a){akeeba.Configuration.engines=a.engines;akeeba.Configuration.installers=a.installers;akeeba.Configuration.parseGuiData(a.gui)};
...
akeeba.Configuration.FtpTest.testConnection=function(a,b,d){var e=document.getElementById("var["+a+"]");akeeba.Configuration.FtpTest.buttonKey="var["+a+"]";e.setAttribute("disabled","disabled");a={isCurl:d?1:0,host:document.getElementById("var["+b+".host]").value,port:document.getElementById("var["+b+".port]").value,user:document.getElementById("var["+b+".user]").value,pass:document.getElementById("var["+b+".pass]").value,initdir:document.getElementById("var["+b+".initial_directory]").value,usessl:document.getElementById("var["+
b+".ftps]").checked,passive:document.getElementById("var["+b+".passive_mode]").checked,passive_mode_workaround:0};d&&(a.passive_mode_workaround=document.getElementById("var["+b+".passive_mode_workaround]").checked);akeeba.System.params.AjaxURL=akeeba.Configuration.URLs.testFtp;console.log(a);console.log(akeeba.System.params.AjaxURL);akeeba.System.doAjax(a,function(a){document.getElementById(akeeba.Configuration.FtpTest.buttonKey).removeAttribute("disabled");var b=document.getElementById("testFtpDialogBodyOk"),
c=document.getElementById("testFtpDialogBodyFail"),d=document.getElementById("testFtpDialogLabel");b.style.display="none";c.style.display="none";!0===a?(d.textContent=akeeba.Configuration.translations.COM_AKEEBA_CONFIG_DIRECTFTP_TEST_OK,b.textContent=akeeba.Configuration.translations.COM_AKEEBA_CONFIG_DIRECTFTP_TEST_OK,b.style.display="block",c.style.display="none"):(d.textContent=akeeba.Configuration.translations.COM_AKEEBA_CONFIG_DIRECTFTP_TEST_FAIL,c.textContent=a,b.style.display="none",c.style.display=
"block");akeeba.Modal.open({inherit:"#testFtpDialog",width:"80%"})},null,!1,15E3)};
...
b+".privkey]").value,pubkey:document.getElementById("var["+b+".pubkey]").value};akeeba.System.params.AjaxURL=akeeba.Configuration.URLs.testSftp;akeeba.System.doAjax(a,function(a){document.getElementById(akeeba.Configuration.SftpTest.buttonKey).removeAttribute("disabled");var b=document.getElementById("testFtpDialogBodyOk"),c=document.getElementById("testFtpDialogBodyFail"),d=document.getElementById("testFtpDialogLabel");b.style.display="none";c.style.display="none";!0===a?(d.textContent=akeeba.Configuration.translations.COM_AKEEBA_CONFIG_DIRECTSFTP_TEST_OK,
b.textContent=akeeba.Configuration.translations.COM_AKEEBA_CONFIG_DIRECTSFTP_TEST_OK,b.style.display="block",c.style.display="none"):(d.textContent=akeeba.Configuration.translations.COM_AKEEBA_CONFIG_DIRECTSFTP_TEST_FAIL,c.textContent=a,b.style.display="none",c.style.display="block");akeeba.Modal.open({inherit:"#testFtpDialog",width:"80%"})},null,!1,15E3)};
...
akeeba.Configuration.GUI.renderOptionTypeBrowsedir=function(a,b,d,e,c){var f=document.createElement("input");f.setAttribute("type","text");f.setAttribute("name",a);f.setAttribute("size","30");f.id=a;f.value=b["default"];a=document.createElement("button");a.className="akeeba-btn--grey";a.setAttribute("title",akeeba.Configuration.translations.COM_AKEEBA_CONFIG_UI_BROWSE);b=document.createElement("span");b.className="akion-folder";a.appendChild(b);akeeba.System.addEventListener(a,"click",function(a){a.preventDefault?
...
akeeba.Configuration.GUI.renderOptionTypeButtonedit=function(a,b,d,e,c){var f="hidden"==b.editortype?"hidden":"text";c=document.createElement("input");c.className="akeeba-configuration-buttonedit";c.setAttribute("type",f);c.setAttribute("name",a);c.setAttribute("size",30);c.value=b["default"];"1"==b.editordisabled&&c.setAttribute("disabled","disabled");a=document.createElement("button");a.innerHTML=akeeba.Configuration.translations[b.buttontitle];a.className="btn";akeeba.System.addEventListener(a,
"click",function(a){a.preventDefault?a.preventDefault():a.returnValue=!1;a=b.hook;try{eval(a+"()")}catch(k){}});f=document.createElement("span");f.className="input-append";f.appendChild(c);f.appendChild(a);d.appendChild(f);e.appendChild(d)};
...
akeeba.Configuration.GUI.renderOptionTypeButton=function(a,b,d,e,c){c=e.querySelector("label");var f=b.hook;b=c.innerHTML;var g=document.createElement("button");g.id=a;g.innerHTML=b;g.className="btn";c.innerHTML="&nbsp;";akeeba.System.addEventListener(g,"click",function(a){a.preventDefault?a.preventDefault():a.returnValue=!1;try{eval(f+"()")}catch(l){}});d.appendChild(g);e.appendChild(d)};
akeeba.Configuration.GUI.renderOptionTypeUnknown=function(a,b,d,e,c){a=a.substr(4,a.length-5);d="akeeba_render_"+b.type;c=window[d];if("function"==typeof c)c(a,b,label,e);else try{eval(d+"(config_key, defdata, label, row_div)")}catch(f){}};akeeba.Configuration.onChangeScriptType=function(a){a=a.options[a.selectedIndex].value;a="joomla"===a?"angie":"angie-"+a;for(var b=document.getElementById("var[akeeba.advanced.embedded_installer]"),d=b.children,e=0;e<d.length;e++)if(d[e].value===a){b.value=a;break}};
...
akeeba_onedrivebusiness_oauth_callback=function(a){document.getElementById("var[engine.postproc.onedrivebusiness.service_id]").value=a.service_id;document.getElementById("var[engine.postproc.onedrivebusiness.refresh_token]").value=a.refresh_token;myWindow=window.open("","akeeba_onedrivebusiness_window");myWindow.close()};
