...
akeeba.Transfer.applyConnection = function () {
    ...
    akeeba.System.doAjax(
        ...
        function (res) {
            ...
            elFtpErrorBody.textContent = akeeba.Transfer.translations["COM_AKEEBA_CONFIG_DIRECTFTP_TEST_FAIL"];
...
akeeba.System.documentReady(function () {
    akeeba.System.addEventListener(document.getElementById("akeeba-transfer-ftp-method"), "change",
        akeeba.Transfer.onTransferMethodChange);
});
