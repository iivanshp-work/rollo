...
akeeba.Extradirs.addRow = function (rootuuid, def, append_to_here)
{
	...
	akeeba.System.addEventListener(elEditSpan, "click", function ()
	{
		...
		elDiskIcon.className = "ak_filter_tab_icon_container akeeba-btn--teal--mini save ak-toggle-button ak-stacked-button";
		...
		elFilterInput.setAttribute("size", "40");
		...
		elVirtualInput.setAttribute("size", "40");
