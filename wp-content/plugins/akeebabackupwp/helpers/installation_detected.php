...
<head>
	...
	<script type="text/javascript"
			src="<?= plugins_url('app/media/js/jquery.min.js', self::$absoluteFileName) ?>"></script>
	<script type="text/javascript"
			src="<?= plugins_url('app/media/js/akjqnamespace.min.js', self::$absoluteFileName) ?>"></script>
	<script type="text/javascript"
			src="<?= plugins_url('app/media/js/jquery-migrate.min.js', self::$absoluteFileName) ?>"></script>
	<script type="text/javascript"
