<?php die(); ?>
Akeeba Backup for WordPress 3.6.0
================================================================================
...
# [HIGH] WP-CLI command "akeeba option list" was broken since 3.4.1
# [MEDIUM] Fixed Javascript error in Database Tables Exclusion page
# [LOW] PHP Warnings when the wp-admin login point has been renamed
