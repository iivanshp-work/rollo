...
?>
    ...
    <?php foreach ( $catalog_orderby_options as $id => $name ) : ?>
        ...
        <option  data-id="<?php echo esc_attr( $id ); ?>" class="<?php echo $a_class ?>" VALUE="<?php echo esc_url( add_query_arg( $filter_value, $shop_page_uri ) ) ?>"><?php echo esc_html( $name ); ?></option>
