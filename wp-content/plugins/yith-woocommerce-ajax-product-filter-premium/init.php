...
if( ! function_exists( 'install_premium_woocommerce_admin_notice' ) ) {
    ...
    function install_premium_woocommerce_admin_notice() { ?>
        <div class="error">
            <p><?php _ex( 'YITH WooCommerce Ajax Product Filter is enabled but not effective. It requires WooCommerce in order to work.', '[Plugin Name]', 'yith-woocommerce-ajax-navigation' ); ?></p>
        </div>
        <?php
    }
}
