...
?>
    <div class="buy-message-block-admin">
        <p class="text">Telegram <?php _e('group', 'coderun-oneclickwoo'); ?>(WordPress, WooCommerce): <span>@coderunphp</span></p>
        <p class="text"><?php _e('Plugin add-on', 'coderun-oneclickwoo'); ?>: <a href="https://coderun.ru/product/woocommerce-uvedomleniya-o-novykh-zakazakh-v-telegram/?utm_source=buyone_plugin"><?php _e('Order notifications to your Telegram', 'coderun-oneclickwoo'); ?></a></p>
        <p class="text"><?php _e('Plugin add-on', 'coderun-oneclickwoo'); ?>: <a href="https://coderun.ru/product/woocommerce-uvedomleniya-o-zakazakh-v-viber/?utm_source=buyone_plugin"><?php _e('Order notifications in your Viber', 'coderun-oneclickwoo'); ?></a></p>
        <p class="text"><?php _e('Plugin add-on', 'coderun-oneclickwoo'); ?>: <a href="https://coderun.ru/product/buy-one-click-woocommerce-variativnye-tovary/?utm_source=buyone_plugin"><?php _e('Variable goods', 'coderun-oneclickwoo'); ?></a></p>
        <p class="text"><a href="https://coderun.ru/?utm_source=buyone_plugin"><?php _e('Marketplace for developers', 'coderun-oneclickwoo'); ?></a></p>
    </div>
