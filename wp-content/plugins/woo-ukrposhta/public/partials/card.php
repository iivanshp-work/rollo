...
<div class="card">
  ...
  <div class="card-body">
    ...
    <a href="plugin-install.php?tab=plugin-information&amp;plugin=morkvaup-plugin&amp;section=changelog&amp;TB_iframe=true&amp;width=772&amp;height=374" class="thickbox open-plugin-details-modal" >встановити останню версію плагіна</a>
...
if(!file_exists($path)){ ?>
  ...
  <div class="card">
        ...
        <div class="card-body">
          ...
          <li>автоматизація та зручність оформленя</li>
