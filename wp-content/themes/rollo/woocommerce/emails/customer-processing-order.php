...
echo "<span style='display: inline-block; margin: 1px 5px 20px 0;font-size: 17px;'>Виконавець:</span>";
echo "<br>";

echo "<span style='width: 100%;display: inline-block;'>";
echo "<span style='width: 33%;display: inline-block;'>";
echo "<strong style='font-size: 17px;'><i>" . "ФОП Левицький Н. С." . "</i></strong>";
echo "</span>";
echo "<span style='width: 33%;display: inline-block;text-align: center;'>";
echo "тел. " . "<strong style='font-size: 16px;'>" . "063-690-00-01" . "</strong>";
echo "</span>";
echo "<span style='width: 33%;display: inline-block;text-align: right;'>";
echo "e-mail: " . "nazarlevitsky@ukr.net";
echo "</span>";
echo "</span>";

echo "<span style='display: inline-block; margin: 5px 5px 5px 0;font-size: 17px;'>79037 м. Львів, вул.Б.Хмельницького, 245 кв.67</span>";
echo "<br>";

echo "<span style='display: inline-block; margin: 5px 5px 5px 0;font-size: 17px;'>МФО 325321<span style='display:inline-block;margin-left:25px;'>ЄДРПОУ 3052406619</span></span>";
echo "<br>";

echo "<span style='display: inline-block; margin: 40px 5px 20px 0;font-size: 17px;'>Замовник:</span>";
echo "<br>";
