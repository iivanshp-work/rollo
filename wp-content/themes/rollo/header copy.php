                ...
                <div class="col-xl-6 col-lg-5 align-self-center">
                    <nav class="header__menu">
                        <ul class="nostyle-list">
                                                    ...
                                                    <ul>
                                                        ...
                                                        if ($pid_link) {
                                                            foreach ($pid_link as $link2) {
                                                                ...
                                                                $image = wp_get_attachment_url($thumbnail_id);
                                                        ?>
                                                                <li><a href="<? echo get_category_link($link); ?>" data-imghov="<? echo $image; ?>" data-texthov=" <? echo get_the_category_by_ID($link); ?>">
                                                                        <? echo get_the_category_by_ID($link); ?></a></li>
                                                        <?
                                                            }
                                                        }
                                                        ?>
                            ...
                            <li>
                            <a href="tel:<? the_field('telefon', $main_page_id); ?>">
