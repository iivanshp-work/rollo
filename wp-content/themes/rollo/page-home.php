            ...
            <ul class="nostyle-list">
                <li>
                    <a href="<? echo $soc['fejsbuk']; ?>" target="_blank">
                        <img src="<? echo get_template_directory_uri() . '/assets/' ?>image/icon/facebook-icon.svg" alt="facebook">
                    </a>
                </li>
                <li>
                    <a href="<? echo $soc['instagram']; ?>" target="_blank">
                        <img src="<? echo get_template_directory_uri() . '/assets/' ?>image/icon/instagram-icon.svg" alt="instagram">
                    </a>
                </li>
                <li>
                    <a href="<? echo $soc['yutub']; ?>" target="_blank">
                        <img src="<? echo get_template_directory_uri() . '/assets/' ?>image/icon/youtube-icon.svg" alt="youtube">
                    </a>
                </li>
            </ul>
        </div>
