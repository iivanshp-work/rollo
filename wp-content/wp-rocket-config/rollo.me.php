...
$rocket_cookie_hash = '9aaa000f6d05c0dbf81ea5a19cd317f7';
$rocket_logged_in_cookie = 'wordpress_logged_in_9aaa000f6d05c0dbf81ea5a19cd317f7';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/ru/checkout/(.*)|/checkout/(.*)|/cart/|/ru/my-account/(.*)|/my-account/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)';
...
$rocket_secret_cache_key = '5f53183523d7d062303580';
$rocket_cache_ssl = 1;
